    ...
    <section id="process" className="section-space bg-[#0b1513]" aria-labelledby="process-title">
      <div className="container-wide">
        <div className="grid gap-8 lg:grid-cols-12 lg:items-end">
          <Reveal variant="editorial" className="lg:col-span-8"><p className="eyebrow">05 · Yolculuğun akışı</p><h2 id="process-title" className="display title-lg mt-7"><TextLines lines={['Siz hayal edin.', <em key="second" className="text-sand-light">Biz kusursuzlaştıralım.</em>]} /></h2></Reveal>
